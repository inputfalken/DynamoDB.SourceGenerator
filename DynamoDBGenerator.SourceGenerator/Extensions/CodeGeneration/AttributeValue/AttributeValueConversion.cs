...
public class AttributeValueConversion
{
    private readonly AttributeValueConversionSettings _attributeValueMFieldAssignment;

    public AttributeValueConversion(in AttributeValueConversionSettings settings)
    {
    ...
    private AttributeValueAssignment BuildList(in ITypeSymbol elementType, in string accessPattern)
    {
    ...
    private AttributeValueAssignment? BuildSet(in ITypeSymbol elementType, in string accessPattern)
    {
    ...
    private bool IsNumeric(in ITypeSymbol typeSymbol) => typeSymbol.SpecialType
    ...
    private AttributeValueAssignment? SingleGenericTypeOrNull(in ITypeSymbol genericType, in string accessPattern)
    {
    ...
    private AttributeValueAssignment? DoubleGenericTypeOrNull(in ITypeSymbol genericType, in string accessPattern)
    {
        if (genericType is not INamedTypeSymbol type)
            return null;
