...
public partial class NullableDecimalIReadOnlySetTests() : SetAsserter<IReadOnlySet<decimal?>, decimal?>([2032m, 0.323232932m, 0.9329392m, null], x => new HashSet<decimal?>(x))
{
    protected override Container<IReadOnlySet<decimal?>> UnmarshallImplementation(Dictionary<string, AttributeValue> attributeValues)
    {
