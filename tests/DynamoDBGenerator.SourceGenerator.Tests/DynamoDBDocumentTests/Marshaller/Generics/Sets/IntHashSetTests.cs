...
public partial class IntHashSetTests : SetAsserter<HashSet<int>, int>
{
    ...
    protected override Container<HashSet<int>> UnmarshallImplementation(Dictionary<string, AttributeValue> attributeValues)
    {
...
public partial class DecimalHashSetTests : SetAsserter<HashSet<decimal>, decimal>
{
    ...
    protected override Container<HashSet<decimal>> UnmarshallImplementation(Dictionary<string, AttributeValue> attributeValues)
    {
        return ContainerMarshaller.Unmarshall(attributeValues);
    }
}