...
public partial class
    NoneNullableIReadOnlyCollectionElementTests : NoneNullableElementAsserter<IReadOnlyCollection<string>, string>
{
    ...
    protected override Dictionary<string, AttributeValue> MarshallImplementation(
        Container<IReadOnlyCollection<string>> text)
    {
        return ContainerMarshaller.Marshall(text);
    }

    protected override Container<IReadOnlyCollection<string>> UnmarshallImplementation(
...
// ReSharper disable once UnusedType.Global
public partial class
    NullableIReadOnlyCollectionElementTests : NullableElementAsserter<IReadOnlyCollection<string?>, string?>
{
