...
public partial class AddCustomConverterWithParamTests : RecordMarshalAsserter<AddCustomConverterWithParamTests.User>
{
    ...
    public AddCustomConverterWithParamTests() : base(new []{new User(new Mail(new MailAddress("something@domain.com")))}, x => MailConverter.WriteImplementation(x.Email))
    {
    }
