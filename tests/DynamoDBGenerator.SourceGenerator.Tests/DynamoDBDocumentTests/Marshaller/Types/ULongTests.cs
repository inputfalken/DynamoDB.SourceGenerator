...
{
    public ULongTests() : base(new ulong[] { ulong.MaxValue, 3232, 8382832838, 3283823828328 },
...
{
    public NullableULongTests() : base(new ulong?[] { ulong.MaxValue, 3232, 8382832838, 3283823828328, null },
