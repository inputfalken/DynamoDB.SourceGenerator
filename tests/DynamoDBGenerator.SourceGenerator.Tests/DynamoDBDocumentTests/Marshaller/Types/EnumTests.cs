...
{
    public StringEnumTests() : base(new [] { DayOfWeek.Monday , DayOfWeek.Friday}, x => new AttributeValue {S = x.ToString()})
    {
    }
...
{
    public NullableStringEnumTests() : base(new DayOfWeek?[] { DayOfWeek.Monday , DayOfWeek.Friday, null}, x => x is not null ? new AttributeValue {S = x.ToString()} : null)
    {
    }
...
{
    public StringCIEnumTests() : base(new [] { DayOfWeek.Monday , DayOfWeek.Friday}, x => new AttributeValue {S = x.ToString().ToUpper()})
    {
    }
...
{
    public NullableStringCIEnumTests() : base(new DayOfWeek?[] { DayOfWeek.Monday , DayOfWeek.Friday, null}, x => x is not null ? new AttributeValue {S = x.Value.ToString().ToUpper()} : null)
    {
    }
...
{
    public NullableIntEnumTests() : base(Enum.GetValues<DayOfWeek>().Cast<DayOfWeek?>().Append(null), x => x is null ? null : new AttributeValue {N = ((int)x).ToString()})
    {
    }
    protected override Container<DayOfWeek?> UnmarshallImplementation(Dictionary<string, AttributeValue> attributeValues)
    {
...
{
    public DefaultNullableEnumTests() : base(Enum.GetValues<DayOfWeek>().Cast<DayOfWeek?>().Append(null), x => x is null ? null : new AttributeValue {N = ((int)x).ToString()})
    {
    }
    protected override Container<DayOfWeek?> UnmarshallImplementation(Dictionary<string, AttributeValue> attributeValues)
    {
